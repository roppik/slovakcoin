...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "slovakcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
        {"dyndns.org", "litecoin.dyndns.org"},
        {"dlinkddns.com", "svknode.dlinkddns.com"},
        {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. slovakcoin is probably already running."), addrBind.ToString().c_str());
        else
